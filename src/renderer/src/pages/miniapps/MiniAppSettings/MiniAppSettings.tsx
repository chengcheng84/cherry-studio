import { Button, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Slider, Switch, Tooltip } from '@cherrystudio/ui'
        ...
        <Section>
          ...
          <div className="space-y-3">
            <PreferenceRow
              ...
              control={<Switch checked={!!openLinkExternal} onCheckedChange={(checked) => void setOpenLinkExternal(checked)} />}
            />
            <PreferenceRow
              ...
              control={
                <div className="w-full min-w-[220px] max-w-[280px] space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Button type="button" variant="ghost" size="icon" onClick={handleResetCacheLimit} aria-label={t('common.reset')}>
                      <RotateCcw className="size-4" />
                    </Button>
                  </div>
                  <Slider
